                            ...
                            <div class="row">
                                    ...
                                    <div class="card ctm-border-radius shadow-sm flex-fill">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">
                                                ...
                                                best not to have many with this
                                                role.
                                            </p>
                                            <div class="mt-2">
                                                <span
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 d-flex">
                                    <div class="card ctm-border-radius shadow-sm flex-fill">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">
                                                Admin to help sort stuff, but
                                                have less access to confidential
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <a
                                                    href="admin.html"
                                                    class="btn btn-theme button-1 ctm-border-radius  float-right text-white"
                                                >
                                                    View Permissions
                                                </a>
                                            </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 d-flex">
                                    <div class="card ctm-border-radius shadow-sm flex-fill">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">
                                                They sort out your payroll and
                                                have access to everyone's salary
                                                information.
                                            </p>
                                            <div class="mt-2">
                                                <span
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 d-flex">
                                    <div class="card ctm-border-radius shadow-sm flex-fill">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">
                                                Team Members have the most
                                                limited access – most people
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    class="form-control datetpicker"
